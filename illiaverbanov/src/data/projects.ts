...
export const projects: Project[] = [
  ...
  },
  {
    ...
    contributions: [
      ...
      'Miracle is live and ongoing — the platform has cleared $1B+ in cumulative trading volume to date, with the incentive and AI modules carrying that traffic in production.',
    ],
  },
  {
    id: 'cult',
